...
public final class IOUtils {
  ...
  public static String toString(@NotNull String url) throws IOException {
  ...
  @NotNull
  public static HttpURLConnection createConnection(@NotNull String url) throws IOException {
